...
btn.addEventListener('DOMContentLoaded', event => {
  let button = document.getElementById('connect')

  button.addEventListener('click', async() => {
    let device
    const VENDOR_ID = 0x09fb
...
const btn_flash = document.getElementById('flash');
btn_flash.addEventListener('DOMContentLoaded', event => {
